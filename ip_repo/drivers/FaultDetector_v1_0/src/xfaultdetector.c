...
XFaultdetector_Trainedregion_o XFaultdetector_Get_trainedRegion_o(XFaultdetector *InstancePtr) {
    ...
    Data.word_12 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA + 48);
    Data.word_13 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA + 52);
    Data.word_14 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA + 56);
    Data.word_15 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA + 60);
    Data.word_16 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA + 64);
    Data.word_17 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA + 68);
    Data.word_18 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA + 72);
    Data.word_19 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA + 76);
    Data.word_20 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA + 80);
    Data.word_21 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA + 84);
    Data.word_22 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA + 88);
    Data.word_23 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA + 92);
    return Data;
}
