...
architecture behave of FaultDetector_control_s_axi is
    ...
    constant ADDR_N_REGIONS_I_DATA_0      : INTEGER := 16#18c#;
    constant ADDR_N_REGIONS_I_CTRL        : INTEGER := 16#190#;
    constant ADDR_N_REGIONS_O_DATA_0      : INTEGER := 16#194#;
    constant ADDR_N_REGIONS_O_CTRL        : INTEGER := 16#198#;
    constant ADDR_ERRORINTASK_BASE        : INTEGER := 16#040#;
    constant ADDR_ERRORINTASK_HIGH        : INTEGER := 16#04f#;
    constant ADDR_LASTTESTDESCRIPTOR_BASE : INTEGER := 16#400#;
    constant ADDR_LASTTESTDESCRIPTOR_HIGH : INTEGER := 16#7ff#;
    ...
    signal int_lastTestDescriptor_address0 : UNSIGNED(3 downto 0);
    signal int_lastTestDescriptor_ce0 : STD_LOGIC;
    signal int_lastTestDescriptor_be0 : UNSIGNED(35 downto 0);
    signal int_lastTestDescriptor_d0 : UNSIGNED(287 downto 0);
    signal int_lastTestDescriptor_address1 : UNSIGNED(3 downto 0);
    signal int_lastTestDescriptor_ce1 : STD_LOGIC;
    signal int_lastTestDescriptor_q1 : UNSIGNED(287 downto 0);
...
-- ----------------------- Memory logic ------------------
    ...
    int_lastTestDescriptor_be0 <= RESIZE(UNSIGNED(lastTestDescriptor_we0), 36);
    int_lastTestDescriptor_d0 <= RESIZE(UNSIGNED(lastTestDescriptor_d0), 288);
    int_lastTestDescriptor_address1 <= raddr(9 downto 6) when ar_hs = '1' else waddr(9 downto 6);
