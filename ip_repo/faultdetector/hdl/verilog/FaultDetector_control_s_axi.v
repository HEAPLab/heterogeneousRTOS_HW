...
#(parameter
    ...
    input  wire [3:0]                    lastTestDescriptor_address0,
    input  wire                          lastTestDescriptor_ce0,
    input  wire [35:0]                   lastTestDescriptor_we0,
    input  wire [287:0]                  lastTestDescriptor_d0,
...
localparam
    ...
    ADDR_N_REGIONS_I_DATA_0      = 11'h18c,
    ADDR_N_REGIONS_I_CTRL        = 11'h190,
    ADDR_N_REGIONS_O_DATA_0      = 11'h194,
    ADDR_N_REGIONS_O_CTRL        = 11'h198,
    ADDR_ERRORINTASK_BASE        = 11'h040,
    ADDR_ERRORINTASK_HIGH        = 11'h04f,
    ADDR_LASTTESTDESCRIPTOR_BASE = 11'h400,
    ADDR_LASTTESTDESCRIPTOR_HIGH = 11'h7ff,
    WRIDLE                       = 2'd0,
    WRDATA                       = 2'd1,
    WRRESP                       = 2'd2,
    WRRESET                      = 2'd3,
...
//------------------------Local signal-------------------
    ...
    wire [3:0]                    int_lastTestDescriptor_address0;
    wire                          int_lastTestDescriptor_ce0;
    wire [35:0]                   int_lastTestDescriptor_be0;
    wire [287:0]                  int_lastTestDescriptor_d0;
    wire [3:0]                    int_lastTestDescriptor_address1;
    wire                          int_lastTestDescriptor_ce1;
    wire [287:0]                  int_lastTestDescriptor_q1;
...
assign int_lastTestDescriptor_address1 = ar_hs? raddr[9:6] : waddr[9:6];
