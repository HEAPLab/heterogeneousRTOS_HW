...
module run_handle_outcome_failedTaskExecutionIds_V_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 8,
    AddressWidth = 4,
    AddressRange = 16
...
reg  [0:0]              sel0_sr;
//------------------------Instantiation------------------
run_handle_outcome_failedTaskExecutionIds_V_RAM_AUTO_1R1W_ram #(
    .DataWidth(DataWidth),
    .AddressWidth(AddressWidth),
    .AddressRange(AddressRange))
run_handle_outcome_failedTaskExecutionIds_V_RAM_AUTO_1R1W_ram_u(
    .clk      ( clk ),
    .reset    ( reset ),
    .ce0      ( ce0 ),
    .address0 ( address0 ),
