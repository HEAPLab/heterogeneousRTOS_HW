# Runtime Tcl commands to interact with - AxiMasterVoter_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/AxiMasterVoter_v1_0_include.tcl
...
# Test: S00_AXI_in
# Create a burst write transaction at s00_axi_in_addr address
create_hw_axi_txn w_s00_axi_in_addr [get_hw_axis $jtag_axi_master] -type write -address $s00_axi_in_addr -len 4 -data $wdata_2 -burst INCR
# Create a burst read transaction at s00_axi_in_addr address
create_hw_axi_txn r_s00_axi_in_addr [get_hw_axis $jtag_axi_master] -type read -address $s00_axi_in_addr -len 4 -burst INCR
# Initiate transactions
run_hw_axi r_s00_axi_in_addr
run_hw_axi w_s00_axi_in_addr
run_hw_axi r_s00_axi_in_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_s00_axi_in_addr]]
# Compare read data
if { $rdata_tmp == $wdata_2 } {
	puts "Data comparison test pass for - S00_AXI_in"
} else {
	puts "Data comparison test fail for - S00_AXI_in, expected-$wdata_2 actual-$rdata_tmp"
	inc ec
}

# Test: S01_AXI_in
# Create a burst write transaction at s01_axi_in_addr address
create_hw_axi_txn w_s01_axi_in_addr [get_hw_axis $jtag_axi_master] -type write -address $s01_axi_in_addr -len 4 -data $wdata_2 -burst INCR
# Create a burst read transaction at s01_axi_in_addr address
create_hw_axi_txn r_s01_axi_in_addr [get_hw_axis $jtag_axi_master] -type read -address $s01_axi_in_addr -len 4 -burst INCR
# Initiate transactions
run_hw_axi r_s01_axi_in_addr
run_hw_axi w_s01_axi_in_addr
run_hw_axi r_s01_axi_in_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_s01_axi_in_addr]]
# Compare read data
if { $rdata_tmp == $wdata_2 } {
	puts "Data comparison test pass for - S01_AXI_in"
} else {
	puts "Data comparison test fail for - S01_AXI_in, expected-$wdata_2 actual-$rdata_tmp"
	inc ec
}

# Test: S02_AXI_in
# Create a burst write transaction at s02_axi_in_addr address
create_hw_axi_txn w_s02_axi_in_addr [get_hw_axis $jtag_axi_master] -type write -address $s02_axi_in_addr -len 4 -data $wdata_2 -burst INCR
# Create a burst read transaction at s02_axi_in_addr address
create_hw_axi_txn r_s02_axi_in_addr [get_hw_axis $jtag_axi_master] -type read -address $s02_axi_in_addr -len 4 -burst INCR
# Initiate transactions
run_hw_axi r_s02_axi_in_addr
run_hw_axi w_s02_axi_in_addr
run_hw_axi r_s02_axi_in_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_s02_axi_in_addr]]
# Compare read data
if { $rdata_tmp == $wdata_2 } {
	puts "Data comparison test pass for - S02_AXI_in"
} else {
	puts "Data comparison test fail for - S02_AXI_in, expected-$wdata_2 actual-$rdata_tmp"
	inc ec
}
