...
architecture behave of FaultDetector_control_s_axi is
    ...
    constant ADDR_TRAINEDREGION_I_DATA_15 : INTEGER := 16#084#;
    constant ADDR_TRAINEDREGION_I_DATA_16 : INTEGER := 16#088#;
    constant ADDR_TRAINEDREGION_I_DATA_17 : INTEGER := 16#08c#;
    constant ADDR_TRAINEDREGION_I_DATA_18 : INTEGER := 16#090#;
    constant ADDR_TRAINEDREGION_I_DATA_19 : INTEGER := 16#094#;
    constant ADDR_TRAINEDREGION_I_DATA_20 : INTEGER := 16#098#;
    constant ADDR_TRAINEDREGION_I_DATA_21 : INTEGER := 16#09c#;
    constant ADDR_TRAINEDREGION_I_DATA_22 : INTEGER := 16#0a0#;
    constant ADDR_TRAINEDREGION_I_DATA_23 : INTEGER := 16#0a4#;
    constant ADDR_TRAINEDREGION_I_CTRL    : INTEGER := 16#0a8#;
    constant ADDR_IOCHECKIDX_DATA_0       : INTEGER := 16#0b8#;
    constant ADDR_IOCHECKIDX_CTRL         : INTEGER := 16#0bc#;
    constant ADDR_IOREGIONIDX_DATA_0      : INTEGER := 16#0c0#;
    constant ADDR_IOREGIONIDX_CTRL        : INTEGER := 16#0c4#;
    constant ADDR_N_REGIONS_I_DATA_0      : INTEGER := 16#0c8#;
    constant ADDR_N_REGIONS_I_CTRL        : INTEGER := 16#0cc#;
    constant ADDR_N_REGIONS_O_DATA_0      : INTEGER := 16#0d0#;
    constant ADDR_N_REGIONS_O_CTRL        : INTEGER := 16#0d4#;
    constant ADDR_ERRORINTASK_BASE        : INTEGER := 16#040#;
    constant ADDR_ERRORINTASK_HIGH        : INTEGER := 16#047#;
    constant ADDR_LASTTESTDESCRIPTOR_BASE : INTEGER := 16#200#;
    constant ADDR_LASTTESTDESCRIPTOR_HIGH : INTEGER := 16#3ff#;
    constant ADDR_TRAINEDREGION_O_BASE    : INTEGER := 16#100#;
    constant ADDR_TRAINEDREGION_O_HIGH    : INTEGER := 16#17f#;
    ...
    signal int_lastTestDescriptor_be0 : UNSIGNED(39 downto 0);
    signal int_lastTestDescriptor_d0 : UNSIGNED(319 downto 0);
    signal int_lastTestDescriptor_address1 : UNSIGNED(2 downto 0);
    signal int_lastTestDescriptor_ce1 : STD_LOGIC;
    signal int_lastTestDescriptor_q1 : UNSIGNED(319 downto 0);
    signal int_lastTestDescriptor_read : STD_LOGIC;
    signal int_lastTestDescriptor_write : STD_LOGIC;
    signal int_lastTestDescriptor_shift1 : UNSIGNED(3 downto 0);
    signal int_trainedRegion_o_address0 : UNSIGNED(4 downto 0);
    signal int_trainedRegion_o_ce0 : STD_LOGIC;
    signal int_trainedRegion_o_be0 : UNSIGNED(3 downto 0);
    signal int_trainedRegion_o_d0 : UNSIGNED(31 downto 0);
    signal int_trainedRegion_o_address1 : UNSIGNED(4 downto 0);
    signal int_trainedRegion_o_ce1 : STD_LOGIC;
    signal int_trainedRegion_o_q1 : UNSIGNED(31 downto 0);
    signal int_trainedRegion_o_read : STD_LOGIC;
    signal int_trainedRegion_o_write : STD_LOGIC;
...
-- int_trainedRegion_o
int_trainedRegion_o : FaultDetector_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "S2P",
     BYTES     => 4,
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_errorInTask_read = '0') and (int_lastTestDescriptor_read = '0') and (int_trainedRegion_o_read = '0') else '0';
    RVALID    <= RVALID_t;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                ...
                elsif (int_trainedRegion_o_read = '1') then
                    rdata_data <= int_trainedRegion_o_q1;
                end if;
            end if;
        end if;
    end process;
...
-- ----------------------- Memory logic ------------------
    ...
    int_lastTestDescriptor_be0 <= RESIZE(UNSIGNED(lastTestDescriptor_we0), 40);
    int_lastTestDescriptor_d0 <= RESIZE(UNSIGNED(lastTestDescriptor_d0), 320);
    int_lastTestDescriptor_address1 <= raddr(8 downto 6) when ar_hs = '1' else waddr(8 downto 6);
    int_lastTestDescriptor_ce1 <= '1' when ar_hs = '1' or (int_lastTestDescriptor_write = '1' and WVALID  = '1') else '0';
    -- trainedRegion_o
    int_trainedRegion_o_address0 <= UNSIGNED(trainedRegion_o_address0);
    int_trainedRegion_o_ce0 <= trainedRegion_o_ce0;
    int_trainedRegion_o_be0 <= (others => trainedRegion_o_we0);
    int_trainedRegion_o_d0 <= RESIZE(UNSIGNED(trainedRegion_o_d0), 32);
    int_trainedRegion_o_address1 <= raddr(6 downto 2) when ar_hs = '1' else waddr(6 downto 2);
    int_trainedRegion_o_ce1 <= '1' when ar_hs = '1' or (int_trainedRegion_o_write = '1' and WVALID  = '1') else '0';
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (ar_hs = '1') then
                    int_lastTestDescriptor_shift1 <= raddr(5 downto 2);
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_trainedRegion_o_read <= '0';
            elsif (ACLK_EN = '1') then
                if (ar_hs = '1' and raddr >= ADDR_TRAINEDREGION_O_BASE and raddr <= ADDR_TRAINEDREGION_O_HIGH) then
                    int_trainedRegion_o_read <= '1';
                else
                    int_trainedRegion_o_read <= '0';
                end if;
            end if;
