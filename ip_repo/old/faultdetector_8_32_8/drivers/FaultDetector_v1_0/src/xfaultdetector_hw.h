...
#define XFAULTDETECTOR_CONTROL_BITS_TRAINEDREGION_I_DATA    768
#define XFAULTDETECTOR_CONTROL_ADDR_IOCHECKIDX_DATA         0x0b8
#define XFAULTDETECTOR_CONTROL_BITS_IOCHECKIDX_DATA         8
#define XFAULTDETECTOR_CONTROL_ADDR_IOREGIONIDX_DATA        0x0c0
#define XFAULTDETECTOR_CONTROL_BITS_IOREGIONIDX_DATA        8
#define XFAULTDETECTOR_CONTROL_ADDR_N_REGIONS_I_DATA        0x0c8
#define XFAULTDETECTOR_CONTROL_BITS_N_REGIONS_I_DATA        8
#define XFAULTDETECTOR_CONTROL_ADDR_N_REGIONS_O_DATA        0x0d0
#define XFAULTDETECTOR_CONTROL_BITS_N_REGIONS_O_DATA        8
#define XFAULTDETECTOR_CONTROL_ADDR_N_REGIONS_O_CTRL        0x0d4
...
#define XFAULTDETECTOR_CONTROL_ADDR_LASTTESTDESCRIPTOR_BASE 0x200
#define XFAULTDETECTOR_CONTROL_ADDR_LASTTESTDESCRIPTOR_HIGH 0x3ff
#define XFAULTDETECTOR_CONTROL_WIDTH_LASTTESTDESCRIPTOR     320
#define XFAULTDETECTOR_CONTROL_DEPTH_LASTTESTDESCRIPTOR     8
#define XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_BASE    0x100
#define XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_HIGH    0x17f
#define XFAULTDETECTOR_CONTROL_WIDTH_TRAINEDREGION_O        32
#define XFAULTDETECTOR_CONTROL_DEPTH_TRAINEDREGION_O        24
