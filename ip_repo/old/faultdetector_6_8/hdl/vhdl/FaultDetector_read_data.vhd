...
attribute shreg_extract : string;
    ...
    signal tmp_3_fu_249_p4 : STD_LOGIC_VECTOR (223 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state16)) then
                ...
                tmp_s_reg_332 <= grp_fu_214_p2(271 downto 264);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    icmp_ln352_fu_175_p2 <= "1" when (unsigned(trunc_ln350_fu_171_p1) > unsigned(ap_const_lv6_1C)) else "0";
    ...
    tmp_3_fu_249_p4 <= lshr_ln352_reg_321(287 downto 64);
