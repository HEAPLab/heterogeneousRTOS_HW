...
#(parameter
    ...
    output wire [575:0]                  trainedRegion_i,
    ...
    input  wire [31:0]                   lastTestDescriptor_we0,
    input  wire [255:0]                  lastTestDescriptor_d0,
...
localparam
    ...
    ADDR_TRAINEDREGION_I_CTRL    = 10'h090,
    ADDR_IOCHECKIDX_DATA_0       = 10'h0a0,
    ADDR_IOCHECKIDX_CTRL         = 10'h0a4,
    ADDR_IOREGIONIDX_DATA_0      = 10'h0a8,
    ADDR_IOREGIONIDX_CTRL        = 10'h0ac,
    ADDR_N_REGIONS_I_DATA_0      = 10'h0b0,
    ADDR_N_REGIONS_I_CTRL        = 10'h0b4,
    ADDR_N_REGIONS_O_DATA_0      = 10'h0b8,
    ADDR_N_REGIONS_O_CTRL        = 10'h0bc,
    ADDR_ERRORINTASK_BASE        = 10'h040,
    ADDR_ERRORINTASK_HIGH        = 10'h047,
    ADDR_LASTTESTDESCRIPTOR_BASE = 10'h100,
    ADDR_LASTTESTDESCRIPTOR_HIGH = 10'h1ff,
    ADDR_TRAINEDREGION_O_BASE    = 10'h200,
    ADDR_TRAINEDREGION_O_HIGH    = 10'h27f,
    WRIDLE                       = 2'd0,
    WRDATA                       = 2'd1,
    WRRESP                       = 2'd2,
    WRRESET                      = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [575:0]                  int_trainedRegion_i = 'b0;
    ...
    wire [31:0]                   int_lastTestDescriptor_be0;
    wire [255:0]                  int_lastTestDescriptor_d0;
    wire [2:0]                    int_lastTestDescriptor_address1;
    wire                          int_lastTestDescriptor_ce1;
    wire [255:0]                  int_lastTestDescriptor_q1;
