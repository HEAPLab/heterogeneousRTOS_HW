...
#define XFAULTDETECTOR_CONTROL_BITS_TRAINEDREGION_I_DATA    384
#define XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA_   0x070
#define XFAULTDETECTOR_CONTROL_BITS_TRAINEDREGION_I_DATA    384
#define XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA    0x080
#define XFAULTDETECTOR_CONTROL_BITS_TRAINEDREGION_O_DATA    384
#define XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_DATA_   0x0a8
#define XFAULTDETECTOR_CONTROL_BITS_TRAINEDREGION_O_DATA    384
#define XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_CTRL    0x0b0
#define XFAULTDETECTOR_CONTROL_ADDR_IOCHECKIDX_DATA         0x0c0
#define XFAULTDETECTOR_CONTROL_BITS_IOCHECKIDX_DATA         8
#define XFAULTDETECTOR_CONTROL_ADDR_IOREGIONIDX_DATA        0x0c8
#define XFAULTDETECTOR_CONTROL_BITS_IOREGIONIDX_DATA        8
#define XFAULTDETECTOR_CONTROL_ADDR_N_REGIONS_I_DATA        0x0d0
#define XFAULTDETECTOR_CONTROL_BITS_N_REGIONS_I_DATA        8
#define XFAULTDETECTOR_CONTROL_ADDR_N_REGIONS_O_DATA        0x0d8
#define XFAULTDETECTOR_CONTROL_BITS_N_REGIONS_O_DATA        8
#define XFAULTDETECTOR_CONTROL_ADDR_N_REGIONS_O_CTRL        0x0dc
...
#define XFAULTDETECTOR_CONTROL_WIDTH_LASTTESTDESCRIPTOR     192
