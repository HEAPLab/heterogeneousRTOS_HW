...
wire  signed [57:0] trunc_ln350_1_fu_151_p4;
reg   [57:0] trunc_ln350_1_reg_277;
...
wire   [1023:0] zext_ln352_fu_197_p1;
reg   [1023:0] zext_ln352_reg_297;
wire   [0:0] icmp_ln332_fu_201_p2;
reg   [511:0] gmem_addr_read_reg_306;
wire    ap_CS_fsm_state13;
wire   [1023:0] grp_fu_214_p2;
reg   [1023:0] lshr_ln352_reg_321;
...
wire   [511:0] grp_read_data_Pipeline_VITIS_LOOP_348_2_fu_144_m_axi_gmem_WDATA;
wire   [63:0] grp_read_data_Pipeline_VITIS_LOOP_348_2_fu_144_m_axi_gmem_WSTRB;
...
wire   [5:0] trunc_ln350_fu_171_p1;
wire   [8:0] shl_ln_fu_189_p3;
wire   [1023:0] grp_fu_214_p0;
wire   [7:0] add_ln365_fu_238_p2;
wire   [223:0] tmp_3_fu_249_p4;
...
FaultDetector_lshr_1024ns_9ns_1024_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .OP( 1 ),
    .din0_WIDTH( 1024 ),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state16)) begin
        ...
        tmp_s_reg_332 <= {{grp_fu_214_p2[271:264]}};
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        trunc_ln350_1_reg_277 <= {{inputAOV[63:6]}};
        zext_ln352_reg_297[8 : 3] <= zext_ln352_fu_197_p1[8 : 3];
    end
end
...
assign grp_fu_214_p0 = {{empty_55_reg_133}, {gmem_addr_read_reg_306}};
...
assign icmp_ln352_fu_175_p2 = ((trunc_ln350_fu_171_p1 > 6'd28) ? 1'b1 : 1'b0);
...
assign tmp_3_fu_249_p4 = {{lshr_ln352_reg_321[287:64]}};

assign tmp_4_fu_258_p4 = {{lshr_ln352_reg_321[39:16]}};

assign trunc_ln350_1_fu_151_p4 = {{inputAOV[63:6]}};

assign trunc_ln350_fu_171_p1 = inputAOV[5:0];
...
always @ (posedge ap_clk) begin
    ...
    zext_ln352_reg_297[1023:9] <= 1015';
end
