...
attribute shreg_extract : string;
    ...
    signal empty_55_reg_133 : STD_LOGIC_VECTOR (255 downto 0);
    ...
    signal tmp_3_fu_249_p4 : STD_LOGIC_VECTOR (159 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state16)) then
                ...
                tmp_s_reg_332 <= grp_fu_214_p2(207 downto 200);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    icmp_ln352_fu_175_p2 <= "1" when (unsigned(trunc_ln350_fu_171_p1) > unsigned(ap_const_lv5_4)) else "0";
    ...
    tmp_3_fu_249_p4 <= lshr_ln352_reg_321(223 downto 64);
