...
-- 0x078 : reserved
-- 0x080 : Data signal of trainedRegion_o
--         bit 31~0 - trainedRegion_o[31:0] (Read)
-- 0x084 : Data signal of trainedRegion_o
--         bit 31~0 - trainedRegion_o[63:32] (Read)
-- 0x088 : Data signal of trainedRegion_o
--         bit 31~0 - trainedRegion_o[95:64] (Read)
-- 0x08c : Data signal of trainedRegion_o
--         bit 31~0 - trainedRegion_o[127:96] (Read)
-- 0x090 : Data signal of trainedRegion_o
--         bit 31~0 - trainedRegion_o[159:128] (Read)
-- 0x094 : Data signal of trainedRegion_o
...
-- 0x0b0 : Control signal of trainedRegion_o
--         bit 0  - trainedRegion_o_ap_vld (Read/COR)
--         others - reserved
-- 0x0c0 : Data signal of IOCheckIdx
--         bit 7~0 - IOCheckIdx[7:0] (Read/Write)
--         others  - reserved
-- 0x0c4 : reserved
-- 0x0c8 : Data signal of IORegionIdx
--         bit 7~0 - IORegionIdx[7:0] (Read/Write)
--         others  - reserved
-- 0x0cc : reserved
-- 0x0d0 : Data signal of n_regions_i
--         bit 7~0 - n_regions_i[7:0] (Read/Write)
--         others  - reserved
-- 0x0d4 : reserved
-- 0x0d8 : Data signal of n_regions_o
--         bit 7~0 - n_regions_o[7:0] (Read)
--         others  - reserved
-- 0x0dc : Control signal of n_regions_o
...
-- 0x100 ~
-- 0x1ff : Memory 'lastTestDescriptor' (8 * 192b)
...
architecture behave of FaultDetector_control_s_axi is
    ...
    constant ADDR_TRAINEDREGION_I_CTRL    : INTEGER := 16#078#;
    constant ADDR_TRAINEDREGION_O_DATA_0  : INTEGER := 16#080#;
    constant ADDR_TRAINEDREGION_O_DATA_1  : INTEGER := 16#084#;
    constant ADDR_TRAINEDREGION_O_DATA_2  : INTEGER := 16#088#;
    constant ADDR_TRAINEDREGION_O_DATA_3  : INTEGER := 16#08c#;
    constant ADDR_TRAINEDREGION_O_DATA_4  : INTEGER := 16#090#;
    constant ADDR_TRAINEDREGION_O_DATA_5  : INTEGER := 16#094#;
    constant ADDR_TRAINEDREGION_O_DATA_6  : INTEGER := 16#098#;
    constant ADDR_TRAINEDREGION_O_DATA_7  : INTEGER := 16#09c#;
    constant ADDR_TRAINEDREGION_O_DATA_8  : INTEGER := 16#0a0#;
    constant ADDR_TRAINEDREGION_O_DATA_9  : INTEGER := 16#0a4#;
    constant ADDR_TRAINEDREGION_O_DATA_10 : INTEGER := 16#0a8#;
    constant ADDR_TRAINEDREGION_O_DATA_11 : INTEGER := 16#0ac#;
    constant ADDR_TRAINEDREGION_O_CTRL    : INTEGER := 16#0b0#;
    constant ADDR_IOCHECKIDX_DATA_0       : INTEGER := 16#0c0#;
    constant ADDR_IOCHECKIDX_CTRL         : INTEGER := 16#0c4#;
    constant ADDR_IOREGIONIDX_DATA_0      : INTEGER := 16#0c8#;
    constant ADDR_IOREGIONIDX_CTRL        : INTEGER := 16#0cc#;
    constant ADDR_N_REGIONS_I_DATA_0      : INTEGER := 16#0d0#;
    constant ADDR_N_REGIONS_I_CTRL        : INTEGER := 16#0d4#;
    constant ADDR_N_REGIONS_O_DATA_0      : INTEGER := 16#0d8#;
    constant ADDR_N_REGIONS_O_CTRL        : INTEGER := 16#0dc#;
    ...
    signal int_trainedRegion_i : UNSIGNED(383 downto 0) := (others => '0');
    signal int_trainedRegion_o_ap_vld : STD_LOGIC;
    signal int_trainedRegion_o : UNSIGNED(383 downto 0) := (others => '0');
    ...
    signal int_lastTestDescriptor_be0 : UNSIGNED(23 downto 0);
    signal int_lastTestDescriptor_d0 : UNSIGNED(191 downto 0);
    signal int_lastTestDescriptor_address1 : UNSIGNED(2 downto 0);
    signal int_lastTestDescriptor_ce1 : STD_LOGIC;
    signal int_lastTestDescriptor_q1 : UNSIGNED(191 downto 0);
...
-- ----------------------- Memory logic ------------------
    ...
    int_lastTestDescriptor_be0 <= RESIZE(UNSIGNED(lastTestDescriptor_we0), 24);
    int_lastTestDescriptor_d0 <= RESIZE(UNSIGNED(lastTestDescriptor_d0), 192);
