...
#(parameter
    ...
    output wire [383:0]                  trainedRegion_i,
    input  wire [383:0]                  trainedRegion_o,
    ...
    input  wire [23:0]                   lastTestDescriptor_we0,
    input  wire [191:0]                  lastTestDescriptor_d0,
...
localparam
    ...
    ADDR_TRAINEDREGION_I_CTRL    = 9'h078,
    ADDR_TRAINEDREGION_O_DATA_0  = 9'h080,
    ADDR_TRAINEDREGION_O_DATA_1  = 9'h084,
    ADDR_TRAINEDREGION_O_DATA_2  = 9'h088,
    ADDR_TRAINEDREGION_O_DATA_3  = 9'h08c,
    ADDR_TRAINEDREGION_O_DATA_4  = 9'h090,
    ADDR_TRAINEDREGION_O_DATA_5  = 9'h094,
    ADDR_TRAINEDREGION_O_DATA_6  = 9'h098,
    ADDR_TRAINEDREGION_O_DATA_7  = 9'h09c,
    ADDR_TRAINEDREGION_O_DATA_8  = 9'h0a0,
    ADDR_TRAINEDREGION_O_DATA_9  = 9'h0a4,
    ADDR_TRAINEDREGION_O_DATA_10 = 9'h0a8,
    ADDR_TRAINEDREGION_O_DATA_11 = 9'h0ac,
    ADDR_TRAINEDREGION_O_CTRL    = 9'h0b0,
    ADDR_IOCHECKIDX_DATA_0       = 9'h0c0,
    ADDR_IOCHECKIDX_CTRL         = 9'h0c4,
    ADDR_IOREGIONIDX_DATA_0      = 9'h0c8,
    ADDR_IOREGIONIDX_CTRL        = 9'h0cc,
    ADDR_N_REGIONS_I_DATA_0      = 9'h0d0,
    ADDR_N_REGIONS_I_CTRL        = 9'h0d4,
    ADDR_N_REGIONS_O_DATA_0      = 9'h0d8,
    ADDR_N_REGIONS_O_CTRL        = 9'h0dc,
...
//------------------------Local signal-------------------
    ...
    reg  [383:0]                  int_trainedRegion_i = 'b0;
    reg                           int_trainedRegion_o_ap_vld;
    reg  [383:0]                  int_trainedRegion_o = 'b0;
    ...
    wire [23:0]                   int_lastTestDescriptor_be0;
    wire [191:0]                  int_lastTestDescriptor_d0;
    wire [2:0]                    int_lastTestDescriptor_address1;
    wire                          int_lastTestDescriptor_ce1;
    wire [191:0]                  int_lastTestDescriptor_q1;
