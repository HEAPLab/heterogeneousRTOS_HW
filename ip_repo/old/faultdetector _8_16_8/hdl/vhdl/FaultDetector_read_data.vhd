...
attribute shreg_extract : string;
    ...
    signal trunc_ln350_1_fu_151_p4 : STD_LOGIC_VECTOR (57 downto 0);
    signal trunc_ln350_1_reg_277 : STD_LOGIC_VECTOR (57 downto 0);
    ...
    signal zext_ln352_fu_197_p1 : STD_LOGIC_VECTOR (1023 downto 0);
    signal zext_ln352_reg_297 : STD_LOGIC_VECTOR (1023 downto 0);
    signal icmp_ln332_fu_201_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal gmem_addr_read_reg_306 : STD_LOGIC_VECTOR (511 downto 0);
    signal ap_CS_fsm_state13 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state13 : signal is "none";
    signal grp_fu_214_p2 : STD_LOGIC_VECTOR (1023 downto 0);
    signal lshr_ln352_reg_321 : STD_LOGIC_VECTOR (1023 downto 0);
    ...
    signal grp_read_data_Pipeline_VITIS_LOOP_348_2_fu_144_m_axi_gmem_WDATA : STD_LOGIC_VECTOR (511 downto 0);
    signal grp_read_data_Pipeline_VITIS_LOOP_348_2_fu_144_m_axi_gmem_WSTRB : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal empty_55_reg_133 : STD_LOGIC_VECTOR (511 downto 0);
    ...
    signal trunc_ln350_fu_171_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal shl_ln_fu_189_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_fu_214_p0 : STD_LOGIC_VECTOR (1023 downto 0);
    signal add_ln365_fu_238_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_3_fu_249_p4 : STD_LOGIC_VECTOR (287 downto 0);
    ...
    component FaultDetector_lshr_1024ns_9ns_1024_4_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        OP : INTEGER;
...
begin
    ...
    lshr_1024ns_9ns_1024_4_1_U3 : component FaultDetector_lshr_1024ns_9ns_1024_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        OP => 1,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state16)) then
                ...
                tmp_s_reg_332 <= grp_fu_214_p2(335 downto 328);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((m_axi_gmem_RVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state12))) then
                empty_55_reg_133 <= m_axi_gmem_RDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                ...
                trunc_ln350_1_reg_277 <= inputAOV(63 downto 6);
                    zext_ln352_reg_297(8 downto 3) <= zext_ln352_fu_197_p1(8 downto 3);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    zext_ln352_reg_297(1023 downto 9) <= "";
    ...
    grp_fu_214_p0 <= (empty_55_reg_133 & gmem_addr_read_reg_306);
    ...
    icmp_ln352_fu_175_p2 <= "1" when (unsigned(trunc_ln350_fu_171_p1) > unsigned(ap_const_lv6_14)) else "0";
    ...
    tmp_3_fu_249_p4 <= lshr_ln352_reg_321(351 downto 64);
    tmp_4_fu_258_p4 <= lshr_ln352_reg_321(39 downto 16);
    trunc_ln350_1_fu_151_p4 <= inputAOV(63 downto 6);
    trunc_ln350_fu_171_p1 <= inputAOV(6 - 1 downto 0);
    zext_ln352_fu_197_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln_fu_189_p3),1024));
end behav;
