...
void XFaultdetector_Set_trainedRegion_i(XFaultdetector *InstancePtr, XFaultdetector_Trainedregion_i Data) {
    ...
    XFaultdetector_WriteReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 48, Data.word_12);
    XFaultdetector_WriteReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 52, Data.word_13);
    XFaultdetector_WriteReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 56, Data.word_14);
    XFaultdetector_WriteReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 60, Data.word_15);
    XFaultdetector_WriteReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 64, Data.word_16);
    XFaultdetector_WriteReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 68, Data.word_17);
    XFaultdetector_WriteReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 72, Data.word_18);
    XFaultdetector_WriteReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 76, Data.word_19);
    XFaultdetector_WriteReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 80, Data.word_20);
    XFaultdetector_WriteReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 84, Data.word_21);
    XFaultdetector_WriteReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 88, Data.word_22);
    XFaultdetector_WriteReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 92, Data.word_23);
}
...
XFaultdetector_Trainedregion_i XFaultdetector_Get_trainedRegion_i(XFaultdetector *InstancePtr) {
    ...
    Data.word_12 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 48);
    Data.word_13 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 52);
    Data.word_14 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 56);
    Data.word_15 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 60);
    Data.word_16 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 64);
    Data.word_17 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 68);
    Data.word_18 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 72);
    Data.word_19 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 76);
    Data.word_20 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 80);
    Data.word_21 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 84);
    Data.word_22 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 88);
    Data.word_23 = XFaultdetector_ReadReg(InstancePtr->Control_BaseAddress, XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA + 92);
    return Data;
}
...
u32 XFaultdetector_Get_trainedRegion_o_BaseAddress(XFaultdetector *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Control_BaseAddress + XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_BASE);
}

u32 XFaultdetector_Get_trainedRegion_o_HighAddress(XFaultdetector *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (InstancePtr->Control_BaseAddress + XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_HIGH);
}

u32 XFaultdetector_Get_trainedRegion_o_TotalBytes(XFaultdetector *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return (XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_HIGH - XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_BASE + 1);
}

u32 XFaultdetector_Get_trainedRegion_o_BitWidth(XFaultdetector *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XFAULTDETECTOR_CONTROL_WIDTH_TRAINEDREGION_O;
}

u32 XFaultdetector_Get_trainedRegion_o_Depth(XFaultdetector *InstancePtr) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    return XFAULTDETECTOR_CONTROL_DEPTH_TRAINEDREGION_O;
}

u32 XFaultdetector_Write_trainedRegion_o_Words(XFaultdetector *InstancePtr, int offset, word_type *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length)*4 > (XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_HIGH - XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(int *)(InstancePtr->Control_BaseAddress + XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_BASE + (offset + i)*4) = *(data + i);
    }
    return length;
}

u32 XFaultdetector_Read_trainedRegion_o_Words(XFaultdetector *InstancePtr, int offset, word_type *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(int *)(InstancePtr->Control_BaseAddress + XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_BASE + (offset + i)*4);
    }
    return length;
}

u32 XFaultdetector_Write_trainedRegion_o_Bytes(XFaultdetector *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);

    int i;

    if ((offset + length) > (XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_HIGH - XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_BASE + 1))
        return 0;

    for (i = 0; i < length; i++) {
        *(char *)(InstancePtr->Control_BaseAddress + XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_BASE + offset + i) = *(data + i);
    }
    return length;
}

u32 XFaultdetector_Read_trainedRegion_o_Bytes(XFaultdetector *InstancePtr, int offset, char *data, int length) {
    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr -> IsReady == XIL_COMPONENT_IS_READY);
    ...
    for (i = 0; i < length; i++) {
        *(data + i) = *(char *)(InstancePtr->Control_BaseAddress + XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_BASE + offset + i);
    }
    return length;
}
