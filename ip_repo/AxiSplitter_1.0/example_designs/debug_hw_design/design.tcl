...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: AxiSplitter_0, and set properties
	set AxiSplitter_0 [ create_bd_cell -type ip -vlnv user.org:user:AxiSplitter:1.0 AxiSplitter_0 ]
	...
	# Connect all clock & reset of AxiSplitter_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins AxiSplitter_0/S_AXI]
	connect_bd_net [get_bd_pins AxiSplitter_0/s_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AxiSplitter_0/s_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of AxiSplitter_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins AxiSplitter_0/M00_AXI]
	connect_bd_net [get_bd_pins AxiSplitter_0/m00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AxiSplitter_0/m00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins AxiSplitter_0/m00_axi_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins AxiSplitter_0/m00_axi_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins AxiSplitter_0/m00_axi_init_axi_txn] [ get_bd_pins slice_block/Dout0 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S01_AXI] [get_bd_intf_pins AxiSplitter_0/M01_AXI]
	connect_bd_net [get_bd_pins AxiSplitter_0/m01_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AxiSplitter_0/m01_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins AxiSplitter_0/m01_axi_txn_done] [get_bd_pins xlconcat_0/In2]
	connect_bd_net [get_bd_pins AxiSplitter_0/m01_axi_error] [get_bd_pins xlconcat_0/In3]
	connect_bd_net [get_bd_pins AxiSplitter_0/m01_axi_init_axi_txn] [ get_bd_pins slice_block/Dout1 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S02_AXI] [get_bd_intf_pins AxiSplitter_0/M02_AXI]
	connect_bd_net [get_bd_pins AxiSplitter_0/m02_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AxiSplitter_0/m02_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins AxiSplitter_0/m02_axi_txn_done] [get_bd_pins xlconcat_0/In4]
	connect_bd_net [get_bd_pins AxiSplitter_0/m02_axi_error] [get_bd_pins xlconcat_0/In5]
	connect_bd_net [get_bd_pins AxiSplitter_0/m02_axi_init_axi_txn] [ get_bd_pins slice_block/Dout2 ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of AxiSplitter_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {AxiSplitter_0/M00_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {AxiSplitter_0/M01_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {AxiSplitter_0/M02_AXI/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M00_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000000} CONFIG.C_M01_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000100} CONFIG.C_M02_AXI_TARGET_SLAVE_BASE_ADDR {0xC0000200} ] [get_bd_cells AxiSplitter_0]

	# Copy all address to AxiSplitter_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/AxiSplitter_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AxiSplitter_0_S_AXI_* ]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:AxiSplitter:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/AxiSplitter_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "AxiSplitter_v1_0_hw_${i}"
