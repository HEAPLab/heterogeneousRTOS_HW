...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M02_AXI_START_DATA_VALUE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_M02_AXI_TARGET_SLAVE_BASE_ADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_M02_AXI_ADDR_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_M02_AXI_DATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_M02_AXI_TRANSACTIONS_NUM" -parent ${Page_0}
