...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S03_AXI] [get_bd_intf_pins axi_peri_interconnect/M01_AXI]
	...
	# Connect all clock & reset of axisvoter_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins axisvoter_0/S_AXI_OUT]
	connect_bd_net [get_bd_pins axisvoter_0/s_axi_out_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axisvoter_0/s_axi_out_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of axisvoter_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins axisvoter_0/M00_AXI_IN]
	connect_bd_net [get_bd_pins axisvoter_0/m00_axi_in_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axisvoter_0/m00_axi_in_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins axisvoter_0/m00_axi_in_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins axisvoter_0/m00_axi_in_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins axisvoter_0/m00_axi_in_init_axi_txn] [ get_bd_pins slice_block/Dout0 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S01_AXI] [get_bd_intf_pins axisvoter_0/M01_AXI_IN]
	connect_bd_net [get_bd_pins axisvoter_0/m01_axi_in_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axisvoter_0/m01_axi_in_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins axisvoter_0/m01_axi_in_txn_done] [get_bd_pins xlconcat_0/In2]
	connect_bd_net [get_bd_pins axisvoter_0/m01_axi_in_error] [get_bd_pins xlconcat_0/In3]
	connect_bd_net [get_bd_pins axisvoter_0/m01_axi_in_init_axi_txn] [ get_bd_pins slice_block/Dout1 ]
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S02_AXI] [get_bd_intf_pins axisvoter_0/M02_AXI_IN]
	connect_bd_net [get_bd_pins axisvoter_0/m02_axi_in_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axisvoter_0/m02_axi_in_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins axisvoter_0/m02_axi_in_txn_done] [get_bd_pins xlconcat_0/In4]
	connect_bd_net [get_bd_pins axisvoter_0/m02_axi_in_error] [get_bd_pins xlconcat_0/In5]
	connect_bd_net [get_bd_pins axisvoter_0/m02_axi_in_init_axi_txn] [ get_bd_pins slice_block/Dout2 ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of axisvoter_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {axisvoter_0/M00_AXI_IN/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {axisvoter_0/M01_AXI_IN/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {axisvoter_0/M02_AXI_IN/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M00_AXI_IN_TARGET_SLAVE_BASE_ADDR {0xC0000000} CONFIG.C_M01_AXI_IN_TARGET_SLAVE_BASE_ADDR {0xC0000100} CONFIG.C_M02_AXI_IN_TARGET_SLAVE_BASE_ADDR {0xC0000200} ] [get_bd_cells axisvoter_0]

	# Copy all address to axisvoter_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/axisvoter_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_axisvoter_0_S_AXI_OUT_* ]]
	puts $fp "set s_axi_out_addr ${offset}"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/axisvoter_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "axisvoter_v1_0_hw_${i}"
