...
#define XFAULTDETECTOR_CONTROL_BITS_TRAINEDREGION_I_DATA    576
#define XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_I_DATA_   0x070
#define XFAULTDETECTOR_CONTROL_BITS_TRAINEDREGION_I_DATA    576
#define XFAULTDETECTOR_CONTROL_ADDR_IOCHECKIDX_DATA         0x0a0
#define XFAULTDETECTOR_CONTROL_BITS_IOCHECKIDX_DATA         8
#define XFAULTDETECTOR_CONTROL_ADDR_IOREGIONIDX_DATA        0x0a8
#define XFAULTDETECTOR_CONTROL_BITS_IOREGIONIDX_DATA        8
#define XFAULTDETECTOR_CONTROL_ADDR_N_REGIONS_I_DATA        0x0b0
#define XFAULTDETECTOR_CONTROL_BITS_N_REGIONS_I_DATA        8
#define XFAULTDETECTOR_CONTROL_ADDR_N_REGIONS_O_DATA        0x0b8
#define XFAULTDETECTOR_CONTROL_BITS_N_REGIONS_O_DATA        8
#define XFAULTDETECTOR_CONTROL_ADDR_N_REGIONS_O_CTRL        0x0bc
...
#define XFAULTDETECTOR_CONTROL_WIDTH_LASTTESTDESCRIPTOR     256
#define XFAULTDETECTOR_CONTROL_DEPTH_LASTTESTDESCRIPTOR     8
#define XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_BASE    0x200
#define XFAULTDETECTOR_CONTROL_ADDR_TRAINEDREGION_O_HIGH    0x27f
#define XFAULTDETECTOR_CONTROL_WIDTH_TRAINEDREGION_O        32
#define XFAULTDETECTOR_CONTROL_DEPTH_TRAINEDREGION_O        18
