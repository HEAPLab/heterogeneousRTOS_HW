...
reg   [7:0] copyInputAOV_in_read_reg_594;
...
reg   [7:0] ap_phi_mux_copyInputAOV_copy_1_phi_fu_278_p8;
reg   [7:0] copyInputAOV_copy_1_reg_274;
reg    ap_block_state1;
...
always @ (posedge ap_clk) begin
    if (((errorInTask_q0 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        copyInputAOV_copy_1_reg_274 <= 8'd0;
...
always @ (*) begin
    if (((errorInTask_load_reg_625 == 1'd0) & (1'b1 == ap_CS_fsm_state7) & (p_read == 8'd2))) begin
        ap_phi_mux_copyInputAOV_copy_1_phi_fu_278_p8 = 8'd0;
    end else begin
