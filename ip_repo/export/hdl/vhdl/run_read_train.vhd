...
port (
    ...
    copyInputAOV_read : IN STD_LOGIC_VECTOR (7 downto 0);
...
attribute shreg_extract : string;
    ...
    signal lnot_reg_381 : STD_LOGIC_VECTOR (0 downto 0);
    signal gmem_blk_n_R : STD_LOGIC;
    signal ap_CS_fsm_state72 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state72 : signal is "none";
    signal copyInputAOV_in_c_blk_n : STD_LOGIC;
    signal lnot_fu_147_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_fu_174_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_reg_391 : STD_LOGIC_VECTOR (7 downto 0);
    signal dest_taskId_V_write_assign5_reg_396 : STD_LOGIC_VECTOR (7 downto 0);
    signal dest_uniId_V_write_assign6_reg_401 : STD_LOGIC_VECTOR (15 downto 0);
    signal dest_command_write_assign7_reg_406 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_s_reg_411 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_reg_416 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_reg_421 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_reg_426 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_4_reg_431 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_5_reg_436 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_reg_441 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_7_reg_446 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state2_io : BOOLEAN;
    signal ap_CS_fsm_state73 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state73 : signal is "none";
    signal p_cast_cast_fu_163_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal p_cast_fu_153_p4 : STD_LOGIC_VECTOR (57 downto 0);
    signal dest_AOV_write_assign_fu_288_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal dest_AOV_write_assign_1_fu_291_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal dest_AOV_write_assign_2_fu_294_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal dest_AOV_write_assign_3_fu_297_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal dest_AOV_write_assign_4_fu_300_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal dest_AOV_write_assign_5_fu_303_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal dest_AOV_write_assign_6_fu_306_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal dest_AOV_write_assign_7_fu_309_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state72)) then
                dest_command_write_assign7_reg_406 <= m_axi_gmem_RDATA(39 downto 32);
                dest_taskId_V_write_assign5_reg_396 <= m_axi_gmem_RDATA(15 downto 8);
                dest_uniId_V_write_assign6_reg_401 <= m_axi_gmem_RDATA(31 downto 16);
                empty_reg_391 <= empty_fu_174_p1;
                tmp_1_reg_416 <= m_axi_gmem_RDATA(127 downto 96);
                tmp_2_reg_421 <= m_axi_gmem_RDATA(159 downto 128);
                tmp_3_reg_426 <= m_axi_gmem_RDATA(191 downto 160);
                tmp_4_reg_431 <= m_axi_gmem_RDATA(223 downto 192);
                tmp_5_reg_436 <= m_axi_gmem_RDATA(255 downto 224);
                tmp_6_reg_441 <= m_axi_gmem_RDATA(287 downto 256);
                tmp_7_reg_446 <= m_axi_gmem_RDATA(319 downto 288);
                tmp_s_reg_411 <= m_axi_gmem_RDATA(95 downto 64);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem_RVALID, copyInputAOV_in_c_full_n, ap_CS_fsm_state2, lnot_reg_381, ap_CS_fsm_state72, ap_block_state2_io)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (lnot_reg_381 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state73;
                elsif (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (lnot_reg_381 = ap_const_lv1_0))) then
    ...
    ap_block_state2_io_assign_proc : process(m_axi_gmem_ARREADY, lnot_reg_381)
    begin
                ap_block_state2_io <= ((lnot_reg_381 = ap_const_lv1_0) and (m_axi_gmem_ARREADY = ap_const_logic_0));
    end process;
    ...
    ap_return_0 <= empty_reg_391;
    ap_return_1 <= dest_taskId_V_write_assign5_reg_396;
    ap_return_10 <= dest_AOV_write_assign_6_fu_306_p1;
    ap_return_11 <= dest_AOV_write_assign_7_fu_309_p1;
    ap_return_2 <= dest_uniId_V_write_assign6_reg_401;
    ap_return_3 <= dest_command_write_assign7_reg_406;
    ap_return_4 <= dest_AOV_write_assign_fu_288_p1;
    ap_return_5 <= dest_AOV_write_assign_1_fu_291_p1;
    ap_return_6 <= dest_AOV_write_assign_2_fu_294_p1;
    ap_return_7 <= dest_AOV_write_assign_3_fu_297_p1;
    ap_return_8 <= dest_AOV_write_assign_4_fu_300_p1;
    ap_return_9 <= dest_AOV_write_assign_5_fu_303_p1;
    ...
    copyInputAOV_in_c_din <= copyInputAOV_read;
    ...
    dest_AOV_write_assign_1_fu_291_p1 <= tmp_1_reg_416;
    dest_AOV_write_assign_2_fu_294_p1 <= tmp_2_reg_421;
    dest_AOV_write_assign_3_fu_297_p1 <= tmp_3_reg_426;
    dest_AOV_write_assign_4_fu_300_p1 <= tmp_4_reg_431;
    dest_AOV_write_assign_5_fu_303_p1 <= tmp_5_reg_436;
    dest_AOV_write_assign_6_fu_306_p1 <= tmp_6_reg_441;
    dest_AOV_write_assign_7_fu_309_p1 <= tmp_7_reg_446;
    dest_AOV_write_assign_fu_288_p1 <= tmp_s_reg_411;
    empty_fu_174_p1 <= m_axi_gmem_RDATA(8 - 1 downto 0);

    gmem_blk_n_AR_assign_proc : process(m_axi_gmem_ARREADY, ap_CS_fsm_state2, lnot_reg_381)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (lnot_reg_381 = ap_const_lv1_0))) then 
    ...
    lnot_fu_147_p2 <= "1" when (copyInputAOV_read = ap_const_lv8_0) else "0";
    m_axi_gmem_ARADDR <= p_cast_cast_fu_163_p1;
    ...
    m_axi_gmem_ARVALID_assign_proc : process(ap_CS_fsm_state2, lnot_reg_381, ap_block_state2_io)
    begin
        if (((ap_const_boolean_0 = ap_block_state2_io) and (ap_const_logic_1 = ap_CS_fsm_state2) and (lnot_reg_381 = ap_const_lv1_0))) then 
    ...
    m_axi_gmem_WVALID <= ap_const_logic_0;
        p_cast_cast_fu_163_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(p_cast_fu_153_p4),64));

    p_cast_fu_153_p4 <= inputAOV(63 downto 6);
end behav;
