# Runtime Tcl commands to interact with - aximvoter_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/aximvoter_v1_0_include.tcl
...
# Test: S00_AXI_IN
# Create a write transaction at s00_axi_in_addr address
create_hw_axi_txn w_s00_axi_in_addr [get_hw_axis $jtag_axi_master] -type write -address $s00_axi_in_addr -data $wdata_1
# Create a read transaction at s00_axi_in_addr address
create_hw_axi_txn r_s00_axi_in_addr [get_hw_axis $jtag_axi_master] -type read -address $s00_axi_in_addr
...
if { $rdata_tmp == $wdata_1 } {
	...
	puts "Data comparison test fail for - S00_AXI_IN, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}

# Test: S01_AXI_IN
# Create a write transaction at s01_axi_in_addr address
create_hw_axi_txn w_s01_axi_in_addr [get_hw_axis $jtag_axi_master] -type write -address $s01_axi_in_addr -data $wdata_1
# Create a read transaction at s01_axi_in_addr address
create_hw_axi_txn r_s01_axi_in_addr [get_hw_axis $jtag_axi_master] -type read -address $s01_axi_in_addr
# Initiate transactions
...
if { $rdata_tmp == $wdata_1 } {
	...
	puts "Data comparison test fail for - S01_AXI_IN, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}

# Test: S02_AXI_IN
# Create a write transaction at s02_axi_in_addr address
create_hw_axi_txn w_s02_axi_in_addr [get_hw_axis $jtag_axi_master] -type write -address $s02_axi_in_addr -data $wdata_1
# Create a read transaction at s02_axi_in_addr address
create_hw_axi_txn r_s02_axi_in_addr [get_hw_axis $jtag_axi_master] -type read -address $s02_axi_in_addr
# Initiate transactions
...
if { $rdata_tmp == $wdata_1 } {
	...
	puts "Data comparison test fail for - S02_AXI_IN, expected-$wdata_1 actual-$rdata_tmp"
	inc ec
}
