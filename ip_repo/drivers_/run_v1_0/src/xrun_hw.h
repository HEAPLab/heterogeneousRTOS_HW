...
#define XRUN_CONTROL_ADDR_ACCEL_MODE_DATA       0x02c
#define XRUN_CONTROL_BITS_ACCEL_MODE_DATA       8
#define XRUN_CONTROL_ADDR_TRAINEDREGION_I_DATA  0x034
#define XRUN_CONTROL_BITS_TRAINEDREGION_I_DATA  768
#define XRUN_CONTROL_ADDR_TRAINEDREGION_I_DATA_ 0x05c
#define XRUN_CONTROL_BITS_TRAINEDREGION_I_DATA  768
#define XRUN_CONTROL_ADDR_TRAINEDREGION_O_DATA  0x098
#define XRUN_CONTROL_BITS_TRAINEDREGION_O_DATA  768
#define XRUN_CONTROL_ADDR_TRAINEDREGION_O_DATA_ 0x0c0
#define XRUN_CONTROL_BITS_TRAINEDREGION_O_DATA  768
#define XRUN_CONTROL_ADDR_IOCHECKIDX_DATA       0x160
#define XRUN_CONTROL_BITS_IOCHECKIDX_DATA       8
#define XRUN_CONTROL_ADDR_IOREGIONIDX_DATA      0x168
#define XRUN_CONTROL_BITS_IOREGIONIDX_DATA      8
#define XRUN_CONTROL_ADDR_N_REGIONS_IN_I_DATA   0x170
#define XRUN_CONTROL_BITS_N_REGIONS_IN_I_DATA   8
#define XRUN_CONTROL_ADDR_N_REGIONS_IN_O_DATA   0x178
