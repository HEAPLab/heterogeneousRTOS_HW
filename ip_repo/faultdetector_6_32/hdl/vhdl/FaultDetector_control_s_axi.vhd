...
-- 0x090 : reserved
-- 0x0a0 : Data signal of IOCheckIdx
--         bit 7~0 - IOCheckIdx[7:0] (Read/Write)
--         others  - reserved
-- 0x0a4 : reserved
-- 0x0a8 : Data signal of IORegionIdx
--         bit 7~0 - IORegionIdx[7:0] (Read/Write)
--         others  - reserved
-- 0x0ac : reserved
-- 0x0b0 : Data signal of n_regions_i
--         bit 7~0 - n_regions_i[7:0] (Read/Write)
--         others  - reserved
-- 0x0b4 : reserved
-- 0x0b8 : Data signal of n_regions_o
--         bit 7~0 - n_regions_o[7:0] (Read)
--         others  - reserved
-- 0x0bc : Control signal of n_regions_o
...
-- 0x100 ~
-- 0x1ff : Memory 'lastTestDescriptor' (8 * 256b)
...
--         Word 8n+7 : bit [31:0] - lastTestDescriptor[n][255:224]
-- 0x200 ~
-- 0x27f : Memory 'trainedRegion_o' (18 * 32b)
...
architecture behave of FaultDetector_control_s_axi is
    ...
    constant ADDR_TRAINEDREGION_I_CTRL    : INTEGER := 16#090#;
    constant ADDR_IOCHECKIDX_DATA_0       : INTEGER := 16#0a0#;
    constant ADDR_IOCHECKIDX_CTRL         : INTEGER := 16#0a4#;
    constant ADDR_IOREGIONIDX_DATA_0      : INTEGER := 16#0a8#;
    constant ADDR_IOREGIONIDX_CTRL        : INTEGER := 16#0ac#;
    constant ADDR_N_REGIONS_I_DATA_0      : INTEGER := 16#0b0#;
    constant ADDR_N_REGIONS_I_CTRL        : INTEGER := 16#0b4#;
    constant ADDR_N_REGIONS_O_DATA_0      : INTEGER := 16#0b8#;
    constant ADDR_N_REGIONS_O_CTRL        : INTEGER := 16#0bc#;
    ...
    constant ADDR_TRAINEDREGION_O_BASE    : INTEGER := 16#200#;
    constant ADDR_TRAINEDREGION_O_HIGH    : INTEGER := 16#27f#;
    ...
    signal int_trainedRegion_i : UNSIGNED(575 downto 0) := (others => '0');
    ...
    signal int_lastTestDescriptor_be0 : UNSIGNED(31 downto 0);
    signal int_lastTestDescriptor_d0 : UNSIGNED(255 downto 0);
    signal int_lastTestDescriptor_address1 : UNSIGNED(2 downto 0);
    signal int_lastTestDescriptor_ce1 : STD_LOGIC;
    signal int_lastTestDescriptor_q1 : UNSIGNED(255 downto 0);
...
-- ----------------------- Memory logic ------------------
    ...
    int_lastTestDescriptor_be0 <= RESIZE(UNSIGNED(lastTestDescriptor_we0), 32);
    int_lastTestDescriptor_d0 <= RESIZE(UNSIGNED(lastTestDescriptor_d0), 256);
