...
#define XRUN_CONTROL_BITS_INPUTAOV_DATA       32
#define XRUN_CONTROL_ADDR_COPYINPUTAOV_I_DATA 0x00028
#define XRUN_CONTROL_BITS_COPYINPUTAOV_I_DATA 8
#define XRUN_CONTROL_ADDR_COPYINPUTAOV_O_DATA 0x00030
#define XRUN_CONTROL_BITS_COPYINPUTAOV_O_DATA 8
