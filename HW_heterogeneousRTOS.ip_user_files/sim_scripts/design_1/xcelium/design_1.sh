...
execute()
{
  xrun $xrun_opts \
       ...
       +incdir+"$ref_dir/../../../../HW_heterogeneousRTOS.gen/sources_1/bd/design_1/ipshared/ee60/hdl" \
       +incdir+"$ref_dir/../../../../HW_heterogeneousRTOS.gen/sources_1/bd/design_1/ipshared/80a0/hdl/verilog" \
       +incdir+"../../../../HW_heterogeneousRTOS.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../HW_heterogeneousRTOS.gen/sources_1/bd/design_1/ipshared/ee60/hdl" \
       +incdir+"../../../../HW_heterogeneousRTOS.gen/sources_1/bd/design_1/ipshared/80a0/hdl/verilog" \
       +incdir+"../../../../HW_heterogeneousRTOS.gen/sources_1/bd/design_1/ip/design_1_FaultDetector_0_1/drivers/FaultDetector_v1_0/src" \
       +incdir+"/opt/tools/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
       -input simulate.do
}
