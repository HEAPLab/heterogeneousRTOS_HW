...
`timescale 1 ns / 1 ps
    ...
    next_task_handler_v1_0_S00_AXI # (
    .C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
    .C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
    ) next_task_handler_v1_0_S00_AXI_inst (
    ...
    next_task_handler_v1_0_S_AXI_INTR # (
    ...
    ) next_task_handler_v1_0_S_AXI_INTR_inst (
        .DONE(DONE),
