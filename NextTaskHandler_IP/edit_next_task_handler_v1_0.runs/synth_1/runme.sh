...
HD_PWD='/home/bosp/workspace/ip_repo/edit_next_task_handler_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log next_task_handler_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source next_task_handler_v1_0.tcl
