...
HD_PWD='/home/bosp/workspace/ip_repo/edit_next_task_handler_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log next_task_handler_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source next_task_handler_v1_0.tcl -notrace
